...
*/
        ...
        sp = new AdvancedSpannableString("Collection Type : "+ labDetail.get("ctype").toString());
        sp.setColor(getActivity().getResources().getColor(R.color.colorPrimary), "Collection Type : ");
        txtFees.setText(sp);
