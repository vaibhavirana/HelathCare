...
public class Function {
    ...
    public static final String DOCTOR_URL = ROOT_URL + "fetch_doctor.php";
    ...
    // doctor
    public static ArrayList<String> doc_list;
                    ...
                    try {
                        ...
                        for (int i = 0; i < ja.length(); i++) {
                            ...
                            if (object.has("doctors")) {
                                jo_city = ja.getJSONObject(i).getJSONObject("doctors");
                                if (jo_city != null) {
                                    doc_list.add(jo_city.getString("drName"));
                                    doc_list_id.add(jo_city.getInt("id"));
                                    Log.e("doctor", doc_list.get(i));
                                }
                            }
                        }
                    } catch (Exception e) {
